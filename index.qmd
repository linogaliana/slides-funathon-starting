...
![](https://git.lab.sspcloud.fr/diit/presentation/energy-data-hack-2022/20220523-day_1-onyxia_onboarding/-/raw/main/slideshow/onyxia_galaxy.png)

## La logique: des services préconfigurés

- Environnement standardisé pour la reproductibilité
- Liberté d'installer des packages
...
- Seuls les domaines institutionnels sont autorisés (universités, écoles, administrations...)  
  _domaines gmail.com, yahoo.fr... non admis_
...
- Chaque service possède un `README`, lisez-le <i class="far fa-smile-wink"></i>
...
- Les **services** sont **éphémères**  
  ...
  **Utilisez MinIO** pour sauvegarder vos données  
  _sinon vous pourriez perdre votre travail_
...
## Lancer un service prêt-à-l'emploi (1/2) {.smaller}
